  ...
  return (
    <>
      ...
      <Container>
        ...
        <Description>This is the Doctor dashboard</Description>
        <CardContainer>
          <Card to="/doctorh/prevappointment" className="doctor-card">
            <CardIcon><FaStethoscope /></CardIcon>
            <CardTitle>Previous Appointments</CardTitle>
            <CardText>Check Previous Appointments Here</CardText>
          </Card>
          <Card to="/doctorh/upcomappointment" className="doctor-card">
            <CardIcon><FaStethoscope /></CardIcon>
            <CardTitle>Upcoming Appointments</CardTitle>
            <CardText>Check Upcoming Appointments Here</CardText>
          </Card>
