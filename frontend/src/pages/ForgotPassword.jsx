...
import { DeoupdateRoute, DoctorupdateRoute, FdoupdateRoute, PatientupdateRoute, AdminupdateRoute } from '../APIRoutes/APIRoutes';
...
const UpdateBox = styled(motion.div)`
...
const roles = [
  { value: 'patient', label: 'Patient', route: PatientupdateRoute },
  { value: 'doctor', label: 'Doctor', route: DoctorupdateRoute },
  { value: 'fdo', label: 'FDO', route: FdoupdateRoute },
  { value: 'deo', label: 'DEO', route: DeoupdateRoute },
  { value: 'admin', label: 'Admin', route: AdminupdateRoute },
];
...
const ForgotPassword = () => {
  ...
  return (
    <UpdateContainer>
      ...
      >
        <UpdateTitle>Reset Password</UpdateTitle>
        ...
        <LinkText>
          Remembered your password? <NavLink onClick={() => navigate('/login')}>Login</NavLink>
        </LinkText>
        <ToastContainer
          position="top-center"
          autoClose={5000}
